  ...
  context "as admin" do
    ...
    describe "#update" do
      ...
      it "updates the department name" do
        ...
        expect(response).to redirect_to edit_department_path(department)
      end
    end
    ...
    describe "#new_user" do
      ...
      it "renders the add user form" do
        ...
        expect(response).to be_successful
        expect(response.body).to include(add_user_department_path(department))
      end
    end
    ...
    describe "#add_user" do
      ...
      context "when user is already in another department" do
        ...
        it "responds with a move user dialog" do
          ...
          expect(response.body).to include(Departments::MoveUserDialogComponent::DIALOG_ID)
    ...
    describe "#change_parent_dialog" do
      ...
      it "renders the change parent dialog with the department tree" do
        ...
        expect(response).to be_successful
        expect(response.media_type).to eq "text/vnd.turbo-stream.html"
        expect(response.body).to include(Departments::ChangeParentDialogComponent::DIALOG_ID)
    ...
    describe "#change_parent" do
      ...
      it "moves the department to a new parent" do
        ...
        expect(response).to redirect_to department_path(new_parent)
      end
    ...
    describe "#new_department" do
      ...
      it "renders the add department form" do
        ...
        expect(response).to be_successful
        expect(response.body).to include(add_department_departments_path)
      end
    ...
    describe "#edit_organization_name" do
      ...
      it "renders the organization name form" do
        ...
        expect(response).to be_successful
        expect(response.media_type).to eq "text/vnd.turbo-stream.html"
        expect(response.body).to include(update_organization_name_departments_path)
    ...
    describe "#cancel_edit_organization_name" do
      ...
      it "renders the organization name display" do
        ...
        expect(response).to be_successful
        expect(response.media_type).to eq "text/vnd.turbo-stream.html"
        expect(response.body).to include(edit_organization_name_departments_path)
      end
    end
    ...
    describe "#destroy_membership" do
      ...
      it "destroys the membership" do
        ...
        expect(response).to redirect_to edit_department_path(department, tab: "memberships")
      end
    end
  end
