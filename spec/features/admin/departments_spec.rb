...
require "spec_helper"
require "support/pages/departments"

RSpec.describe "Departments admin",
               :js do
  shared_let(:admin) { create(:admin) }

  let(:departments_page) { Pages::Departments.new }
  ...
  describe "canceling add department" do
    ...
    it "hides the form on cancel" do
      ...
      departments_page.wait_for_turbo_frame { departments_page.click_add_department }
  ...
  describe "canceling add user" do
    ...
    it "hides the form on cancel" do
      ...
      departments_page.wait_for_turbo_frame { departments_page.click_add_user }
  ...
  describe "moving a user between departments" do
    ...
    it "shows a confirmation dialog and moves the user" do
      ...
      dialog_id = Departments::MoveUserDialogComponent::DIALOG_ID
